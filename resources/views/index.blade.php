    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}"><span>MadaNews</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto"></ul><a class="btn btn-primary shadow" role="button" href="{{ url('/ToSignUp') }}">S'inscrire</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    <h2 class="display-6 fw-bold mb-5"><span class="underline pb-1"><strong>Se connecter</strong><br></span></h2>
                    <form action="{{ url('/Signin') }}" method="post">
                        ...
                        @if(session()->has('Error'))
                            <div class="alert alert-success flash animated" role="alert" style="color: var(--bs-red);background: rgb(255, 255, 255);border-width: 1px;border-top-width: 1px;border-top-color: var(--bs-red);border-right-color: var(--bs-red);border-bottom-color: var(--bs-red);border-left-color: var(--bs-red);">
                                <span><strong>!</strong> Email ou mot de passe incorrect.</span>
                            </div>
                        @endif
                        <div class="mb-3"><input class="shadow form-control" type="email" name="email" placeholder="Email"></div>
                        <div class="mb-3"><input class="shadow form-control" type="password" name="password" placeholder="Mot de passe"></div>
                        <div class="mb-5"><button class="btn btn-primary shadow" type="submit">Se Connecter</button></div>
                        <p class="text-muted"><a href="{{ url('/ForgetPass') }}">Mot de passe oublié?</a></p>
                    </form>
                </div>
            </div>
        </div>
