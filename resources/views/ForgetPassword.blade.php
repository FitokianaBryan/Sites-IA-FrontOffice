    ...
    <section class="py-4 py-md-5 mt-5">
        <div class="container py-md-5">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 text-center"><img class="img-fluid w-100" src="<?php echo asset('assets/img/illustrations/desk.svg');?>"></div>
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    <h2 class="display-6 fw-bold mb-4">Mot de passe&nbsp;<span class="underline">oublié</span>?</h2>
                    <p class="text-muted">Entrer votre email et votre nouveau mot de passe pour pouvoir enregistrer le nouveau.</p>
                    <form action="{{ url('/ResetPass') }}" method="post">
                        ...
                        <div class="mb-3"><input class="form-control shadow" type="password" name="password" placeholder="Nouveau mot de passe"></div>
                        <div class="mb-3"><input class="form-control shadow" type="password" placeholder="Retapez le mot de passe" name="password_repeat"></div>
                        <div class="mb-5"><button class="btn btn-primary shadow" type="submit">Enregistrer</button></div>
                    </form>
                </div>
            </div>
        </div>
