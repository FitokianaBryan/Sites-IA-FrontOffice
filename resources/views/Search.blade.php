        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="display-6 fw-bold mb-4">Rechercher une&nbsp;&nbsp;<br><span class="underline">information</span></h2>
                    <p class="text-muted">Vous pouvez chercher une information en entrant certaines caractéristiques de celui-ci.&nbsp;</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form action="{{ url('/Search') }}" class="p-3 p-xl-4" method="post">
                            {{ csrf_field() }}
                            <div class="mb-3"><input class="shadow form-control" type="text" id="name-1" name="catégorie" placeholder="Catégorie"></div>
                            <div class="mb-3"><input class="form-control" type="text" name="titre" placeholder="titre"></div>
                            <div class="mb-3"><textarea class="shadow form-control" id="message-1" name="texte" rows="6" placeholder="Contenue"></textarea></div>
                            <div><button class="btn btn-primary shadow d-block w-100" type="submit">Rechercher</button></div>
                        </form>
                    </div>
                </div>
            </div>
